...
Read more here: [Chia Keys Management](https://github.com/Kale-Network/kale-blockchain/wiki/Chia-Keys-Management#2-keys-farming-key--cold-storage-key) and [Good Security Practices on Many Machines](https://github.com/Kale-Network/kale-blockchain/wiki/Good-Security-Practices-on-Many-Machines)
